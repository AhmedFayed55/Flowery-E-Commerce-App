...
void main() {
  test(
    'when call toEntity with nullable values it should return entity with null values',
    () {
  ...
  test(
    'when call toEntity with non-null values it should return entity with correct values',
    () {
      OccasionsResponseDto dto = OccasionsResponseDto(
        message: "Success",
