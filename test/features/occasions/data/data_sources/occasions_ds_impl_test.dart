...
void main() {
  test('verify when call getAllOccasions it should call getAllOccasions from ApiServices', () async{

    final ApiServices apiServices = MockApiServices();
    OccasionsDataSourceImpl dataSourceImpl = OccasionsDataSourceImpl(apiServices);
    ...
    when(apiServices.getOccasions()).thenAnswer((_) async => expectedResponse);
    ...
    expect(result.products?.length, equals(expectedResponse.products?.length));
