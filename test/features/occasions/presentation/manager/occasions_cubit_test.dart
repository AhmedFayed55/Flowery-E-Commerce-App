...
void main() {
  group("occasions view model test", () {
    ...
    final OccasionsCubit viewModel = OccasionsCubit(useCase);
    ...
    blocTest<OccasionsCubit, OccasionsState>(
      ...
      act: (viewModel) => viewModel.doIntent(LoadOccasionsEvent(), "1"),
      expect: () => [
        OccasionsState(isLoadingGetOccasion: true, products: const []),
        OccasionsState(
    ...
    blocTest<OccasionsCubit, OccasionsState>(
      ...
      act: (cubit) => cubit.doIntent(LoadOccasionsEvent(), "1"),
      expect: () => [
