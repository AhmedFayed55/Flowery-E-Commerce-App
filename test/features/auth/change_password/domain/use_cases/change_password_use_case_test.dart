...
import 'package:flowers_ecommerce_app/features/auth/change_password/domain/repositories/change_password_repo.dart';
...
void main() {
  ...
  const ChangePasswordResponseEntity expectedResponse =
      ChangePasswordResponseEntity(token: "aSC", message: "good");
  ...
  test(
    ...
    () async {
      when(repo.changePassword(requestEntity)).thenAnswer(
        (_) async => ApiSuccessResult<ChangePasswordResponseEntity>(
