...
import 'package:flowers_ecommerce_app/features/auth/reset_password/data/repositories/change_password_repo_impl.dart';
...
void main() {
  ...
  final ChangePasswordRequestDto requestDto = ChangePasswordRequestDto(password: "1",newPassword: "2");
  final ChangePasswordRequestEntity requestEntity = ChangePasswordRequestEntity(password: "1",newPassword: "2");
  final ChangePasswordResponseDto expectedResponse = ChangePasswordResponseDto(
      message: "Good",
      token: "jhbkjas");

  test('should return ApiSuccessResult when successfully', () async{

    when(dataSource.changePassword(requestDto)).thenAnswer((_) async => expectedResponse);
  ...
  test('should return ApiErrorResult when unexpected error is thrown', () async{
