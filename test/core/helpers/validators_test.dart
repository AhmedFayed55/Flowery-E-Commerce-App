...
void main() {
  ...
  group("Email Validation Test", (){
    ...
    test("when invalid should return error", (){
      expect(Validations.validateEmail("ahmedfayed.com"), "This Email is not valid");
    });
  ...
  group("Password Validation Test", (){
    ...
    test("when invalid should return error", (){
      expect(Validations.validatePassword("123456"), "This Password is not valid");
    });
  ...
  group("Phone number Validation", (){
    ...
    test("when invalid should return error", (){
      expect(Validations.validatePhoneNumber("0115916"), "This Phone number is not valid");
    });
  ...
  group("Confirm password Validation", (){
    ...
    test("when empty should return error", (){
      expect(Validations.validateConfirmPassword(password , ""), "Confirm Password is required!");
    });

    test("when invalid should return error", (){
      expect(Validations.validateConfirmPassword(password , "12354341"), "This Confirm Password is not valid");
    });

    test("when not match should return error", (){
      expect(Validations.validateConfirmPassword(password , "A7medfayd@5"), "Password and Confirm Password must be same!");
    });

    test("when valid should return error", (){
      expect(Validations.validateConfirmPassword(password , "A7medfayed@5"), null);
    });
  });
}