          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                verticalSpace(16),
                Text(
                  AppLocalizations.of(context)!.please_enter_your_code_that_send_to_your_email_address,
                    ...
                    InkWell(
                      ...
                      child: Text(
                        ...
                        style: Theme.of(context).textTheme.displayMedium?.copyWith(
                                color: isResend ? AppColors.pink : AppColors.darkGrey ,
                                decoration: isResend ? TextDecoration.underline : TextDecoration.none,
                                decorationStyle: TextDecorationStyle.solid,
                                decorationColor: isResend ? AppColors.pink : AppColors.darkGrey,
                              )
                      ),
                    ),
                  ],
