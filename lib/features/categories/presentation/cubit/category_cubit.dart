...
class CategoryCubit extends Cubit<CategoryState> {
  ...
  CategoryCubit({required this.getAllCategoryRepositoryContract})
  ...
  Future<void> _getAllCategory() async {
    ...
    switch (result) {
      case ApiSuccessResult<List<CategoryModel>>():
        emit(state.copyWith(isSuccess: true,skeletonizerLoading: false,listCategoryModel: result.data));
